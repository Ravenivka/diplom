...
<div class="reg_main">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <textarea id="address" name="address" class="reg-address" >Ваш адрес</textarea>
        </div>

        <div class="reg-alredy">
            <a  href="/aut/{{ $parent }}" style="color: white; font-family: Arial, Helvetica, sans-serif , sans-serif; font-size: 12px;">Already registered?</a>
